...
import { Loader2, Save, BadgePercent, Clock } from 'lucide-react';
...
export const GlobalSalarySettings: React.FC = () => {
    ...
    const handleSave = async () => {
        ...
        if (isNaN(numOtRate) || numOtRate < 0 || isNaN(numEpfRate) || numEpfRate < 0) {
            toast({
                title: "Invalid Input",
                description: "OT Rate and EPF Rate must be valid, non-negative numbers.",
                variant: "destructive",
            });
            return;
        }
        ...
        setIsSaving(true);
        await saveSettings({ otRate: numOtRate, epfRate: numEpfRate });
        setIsSaving(false);
    };
    ...
    return (
        <Card className="shadow-md">
            <CardHeader>
                ...
                <CardDescription>
                    Configure global rates for Overtime (OT) and Employee Provident Fund (EPF). These values will apply to all salary calculations.
                </CardDescription>
            </CardHeader>
